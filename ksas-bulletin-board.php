        ...
        <p>
          ...
          <?php global $wpdb;
            ...
            foreach ($categories as $category) {
               ...
               <option value="<?php echo $category_choice; ?>" <?php if ($category_choice == $instance['category_choice']) {
        ...
        public function widget($args, $instance)
    {
          ...
          <?php if ($bulletin_board_query->have_posts()): while ($bulletin_board_query->have_posts()): $bulletin_board_query->the_post();?>
            ...
            <article aria-label="Bulletins Archive">
              <p><a href="<?php echo home_url('/bbtype/');
                echo $category_choice; ?>">View more Bulletins <span class="fa fa-chevron-circle-right" aria-hidden="true"></span></a></p>
            </article>
    ...
    function expire_bulletin_alert()
{
        ...
        if ($expire_query->have_posts()) {
            ...
            while ($expire_query->have_posts()): $expire_query->the_post();
